...
class Solution(ScriptBase):
    ...
    def __init__(self, name: str, version: cmdpart.Version = None, langs: str = None, cmakemin: cmdpart.Version = None):
        super().__init__()
        self._Name = None
        self.Name = name
        """Name of the project"""
        ...
        if self.Min_CMakeVersion is None: self.Min_CMakeVersion = cmdpart.Version(2,8)
        return
    ...
    def render_body(self):
        ...
        if not isinstance(self.Version, cmdpart.Version): raise ValueError("Project Version must be a Version class")
        if not isinstance(self.Langs, str): raise ValueError("Project Langs must be a string")
        if not isinstance(self.Min_CMakeVersion, cmdpart.Version): raise ValueError("Project CMake Minimum Version must be a Version class")
